		...
		while (maxLogin > 0) {
			...
			while (isUser) 
			{
				...
				case 3:
					...
					li = (TreeMap<String, LinkedHashMap<String, String>>) ois
							.readObject();
					}
					catch(IOException e) {}
					Admin.search(li);
				...
				case 4:
					...
					lih = (TreeMap<String, LinkedHashMap<String, String>>) ois1
							.readObject();
					}
				...
				case 7:
					...
					li21 = (TreeMap<String, LinkedHashMap<String, String>>) ois21
							.readObject();
					} 
					catch(IOException e) {}
					Admin.search(li21);
